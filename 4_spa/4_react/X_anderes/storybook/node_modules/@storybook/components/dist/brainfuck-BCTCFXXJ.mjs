...
]`,{returnEnd:!0,relevance:0}),{className:"title",begin:"[\\[\\]]",relevance:0},{className:"string",begin:"[\\.,]",relevance:0},{begin:/(?:\+\+|--)/,contains:[LITERAL]},LITERAL]}}module.exports=brainfuck;}});var brainfuckBCTCFXXJ = require_brainfuck();

export { brainfuckBCTCFXXJ as default };
